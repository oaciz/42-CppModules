...
void PmergeMe::process()
{
    ...
    std::cout << "Time to process a range of " << this->_vector.size() << " elements with std::[..] : " << static_cast<float>(v) / CLOCKS_PER_SEC * 1000 << " us" << std::endl;
    std::cout << "Time to process a range of " << this->_deque.size() << " elements with std::[..] : " << static_cast<float>(d) / CLOCKS_PER_SEC * 1000 << " us" << std::endl;
}
